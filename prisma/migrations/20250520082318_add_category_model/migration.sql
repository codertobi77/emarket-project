-- CreateEnum
CREATE TYPE "Role" AS ENUM ('BUYER', 'SELLER', 'MANAGER', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "markets" ADD CONSTRAINT "markets_managerId_fkey" FOREIGN KEY ("managerId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
